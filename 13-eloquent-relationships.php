 ...
 * 
 * Например, есть таблицы images, categories и category_image (пивотная).
 * И этот метод будет искать классы Image и Category и когда найдёт, 
 * то потом будет искать таблицы в базе с таким же название и 
 * автоматически преобразует их во множественное число
 * 
 * В пивотоной таблице будут столбцы image_id, category_id
 */
...
/*
 * Вывести все стать и указанной категории
 */
